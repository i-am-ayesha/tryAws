                            ...
                            sshPublisherDesc(
                                ...
                                transfers: [sshTransfer(
                                    execCommand: """
                                        ...
                                        docker run -d --name distance-converter-container -p 80:80 ayesha65/personal-portfolio:${env.BUILD_ID}
                                    """
                                )]
                            )
                        ]
                        ...
                        sshPublisher(
                            publishers: [
                                sshPublisherDesc(
                                    ...
                                    transfers: [sshTransfer(
                                        execCommand: """
                                            docker pull ayesha65/personal-portfolio:${previousSuccessfulTag}
                                            docker stop personal-portfolio-container || true
                                            docker rm   personal-portfolio-container || true
                                            docker run -d --name personal-portfolio-container -p 80:80 ayesha65/personal-portfolio:${previousSuccessfulTag}
                                        """
                                    )]
                                )
                            ]
